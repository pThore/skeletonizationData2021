...
to run the algorithm type: "testSkeleton 50 ../data/input/DTMap.prop  > ../data/output/skeleton.skel" in this folder. The output skeleton file is generated in the folder "data/output" under the name "skeleton.skel".
